...
$templates->documentHead("Results");
?>
<body class="bg-[#f4f5fa]">
            ...
            <div class="mx-auto max-w-7xl">
                <div class="md:flex md:flex-grow md:gap-[24px]">
                    <div class="md:basis-3/12 md:mb-0 mb-6">
                        <?php $templates->geekBrainsNavigation("Results"); ?>
                    </div>
                    <div class="md:basis-9/12">
                        <div class="bg-white p-[32px] rounded-[32px]">
                            <div class="mb-4">
                                <h1 class="font-onest font-medium md:text-[24px] text-[20px] text-[#191816]">Работа с аудиофайлами</h1>
                            </div>
                            <div>
    ...
    <?php
    $templates->documentJavascript("Results");
    ?>
</body>
</html>